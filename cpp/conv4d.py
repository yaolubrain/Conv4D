...
class CostFunction(Function):
    ...
    def forward(ctx, feat1, feat2, max_offset_h, max_offset_w):
        ...
        cost = conv4d_cpp.compute_cost_volume_forward(feat1, feat2, max_offset_h, max_offset_w)
    ...
    def backward(ctx, grad_output):        
        ...
        grad_feat1, grad_feat2 = conv4d_cpp.compute_cost_volume_backward(grad_output, feat1, feat2, ctx.max_offset_h, ctx.max_offset_w)
...
class Conv4dFunction(Function):
    ...
    def backward(ctx, grad_outputs):
        ...
        grad_inputs, grad_weight = conv4d_cpp.conv4d_backward(grad_outputs, inputs, weight, ctx.channels_in, ctx.channels_out, ctx.ksize, ctx.stride, ctx.padding, ctx.dilation)
